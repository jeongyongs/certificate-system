...
(
    resident_serial_number       INT auto_increment NOT NULL,
...
(
    household_serial_number           INT auto_increment NOT NULL,
...
MERGE INTO resident VALUES (1, '남길동', '130914-*******', '남', '1913-09-14 07:22:00', '자택', '경기도 성남시 분당구 대왕판교로645번길',
                            '2021-04-29 09:03:00', '주택', '강원도 고성군 금강산로 290번길');
MERGE INTO resident VALUES (2, '남석환', '540514-*******', '남', '1954-05-14 17:30:00', '병원', '경기도 성남시 분당구 대왕판교로645번길',
                            NULL, NULL, NULL);
MERGE INTO resident VALUES (3, '박한나', '551022-*******', '여', '1955-10-22 11:15:00', '병원', '서울특별시 중구 세종대로 110번길', NULL,
                            NULL, NULL);
MERGE INTO resident VALUES (4, '남기준', '790510-*******', '남', '1979-05-10 20:45:00', '병원', '경기도 성남시 분당구 대왕판교로645번길',
                            NULL, NULL, NULL);
MERGE INTO resident VALUES (5, '이주은', '820821-*******', '여', '1982-08-21 01:28:00', '병원', '경기도 수원시 팔달구 효원로 1번길', NULL,
                            NULL, NULL);
MERGE INTO resident VALUES (6, '이선미', '851205-*******', '여', '1985-12-05 22:01:00', '병원', '경기도 수원시 팔달구 효원로 1번길', NULL,
                            NULL, NULL);
MERGE INTO resident VALUES (7, '남기석', '120315-*******', '남', '2012-03-15 14:59:00', '병원', '경기도 성남시 분당구 대왕판교로645번길',
                            NULL, NULL, NULL);
